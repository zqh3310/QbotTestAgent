#!/usr/bin/env bash
# QA-only helper: expose runner-owned SkillHub fixtures and product-owned dev
# connector fixtures from one control-plane process. deepbankV2 remains read-only.
set -euo pipefail
