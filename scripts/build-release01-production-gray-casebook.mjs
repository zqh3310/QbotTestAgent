...
const MR_WINDOW_END = '2026-08-27T15:00:00+08:00';
...
// 本地只读 release ref 在 2026-08-27 15:00 CST 冻结的增量 MR 文件清单。
...
async function main() {
  ...
  addSheet(workbook, '源码依据', 'Casebook源码与审计依据', '所有依据均绑定固定commit；deepbankV2仓库只读，QbotTestAgent负责Case、执行器、证据和放行规则。',
    ['类型', '位置/版本', '用途', '校验'], [
      ...
      ['上一Casebook产品基线', PREVIOUS_CASEBOOK_PRODUCT_COMMIT, '冻结18个新增直接合入MR的审计起点', '本地只读提交可达；增量文件清单由单次只读请求冻结'],
