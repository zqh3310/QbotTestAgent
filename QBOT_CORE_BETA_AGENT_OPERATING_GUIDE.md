...
- 自动化覆盖活动流、Web 搜索与 SSRF、目录授权、interval 真实到点、侧栏布局、
  ...
  不在 12 条通过结论中豁免。
- 本版以北京时间 2026-08-24 00:00 至 2026-08-28 01:06:27 的 first-parent 为准，共审计
  73 个 `origin/release/0.1` 直接合入 MR；工作簿 `近2天MR覆盖` Sheet 对每个 merge commit
  ...
  !1359、!1361、!1364、!1358、!1365、!1428、!1430、!1443、!1450、!1451、!1374。
- `!1374` 的 Auto fallback/catalog authority 变更映射 `MRSMOKE-ROUTE-001`、`MRSMOKE-FAIL-001`、
  `BETA-CHAT-005` 与 `BETA-PERF-003`，核对 fallback 来源、路由稳定性和长文本恢复。
...
`origin/release/0.1` 的 73 个 MR、最新产品源码和历史 Casebook 收敛审计。MR 映射、
