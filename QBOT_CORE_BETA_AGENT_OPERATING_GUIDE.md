...
- 最新正式 Casebook 已更新为
  ...
  SHA-256 `d72552de135e5d3fca1896c954d74323c47366d664f92a3273b4e16e39e3f670`，
  设计基线 `origin/release/0.1@f22edbac971f53e5ec743dd63d93f4dcf2fd99e1`、产品版本
  `0.1.6`。相对旧基线新增 25 个直接合入 MR：!1334、!1331、!1330、!1332、!1336、
  !1337、!1338、!1310、!1339、!1340、!1333、!1341、!1326、!1342、!1320、
  !1344、!1343、!1345、!1346、!1349、!1348、!1350、!1355、!1354、!1356；其他产品行为
  变更映射到现有 12/70/160 Case。当前受管 `.7@8f001d12` 只覆盖到 !1341，不能代表
  最新 release/0.1；必须等待包含 `f22edbac` 的 SIT 候选，形成包含新 Casebook、规范
...
- 产品设计基线：`origin/release/0.1`，
  commit `f22edbac971f53e5ec743dd63d93f4dcf2fd99e1`，版本 `0.1.6`。
...
- 自动化覆盖活动流、Web 搜索与 SSRF、目录授权、interval 真实到点、侧栏布局、
  ...
  不在 12 条通过结论中豁免。
- 本版以北京时间 2026-08-24 00:00 至 2026-08-27 18:00 的 first-parent 为准，共审计
  60 个 `origin/release/0.1` 直接合入 MR；工作簿 `近2天MR覆盖` Sheet 对每个 merge commit
...
Casebook 的设计依据包括 2026-08-24 00:00 至 2026-08-27 18:00 直接合入
`origin/release/0.1` 的 60 个 MR、最新产品源码和历史 Casebook 收敛审计。MR 映射、
...
npm run core-beta:pretest -- \
  ...
  --expected-count 70 \
  --expected-sha256 d72552de135e5d3fca1896c954d74323c47366d664f92a3273b4e16e39e3f670 \
